...
namespace ControlEscolar
{
    public partial class Profesores : Form
    {
        ...
        {     
            ...
            _profesorManejador.GetGrupo(cmbGrupo);
            _profesorManejador.GetMaterias(cmbMateria);
        }
        ...
        private void Modificar()
        {
            ...
            cmbMateria.Text = dtgProfesores.CurrentRow.Cells["materia"].Value.ToString();
            cmbGrupo.Text = dtgProfesores.CurrentRow.Cells["grupo"].Value.ToString();
