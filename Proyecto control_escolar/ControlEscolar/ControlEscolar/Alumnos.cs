...
namespace ControlEscolar
{
    public partial class Alumnos : Form
    {
        ...
        private void Alumnos_Load(object sender, EventArgs e)
        {
            ...
            _alumnoManejador.GetGrupos(cmbGrupo);
            
        }
        private void controlbotones(bool nuevo, bool guardar, bool cancelar, bool eliminar, bool cargar)
        {
            btnNuevo.Enabled = nuevo;
            btnGuardar.Enabled = guardar;
            btnCancelar.Enabled = cancelar;
            btnEliminar.Enabled = eliminar;
            btncargar.Enabled = cargar;
        }
        ...
        {
            _alumnoManejador.Guardarmaterias(new Entidades.ControlEscolar.v_materias
            {
                Idmateria = Convert.ToInt32(lblds.Text),
                Numerocontrol = txtnocontrol.Text,
        ...
        {
            controlcajas(true);
            controlbotones(false, true, true, false, true);
            ...
            cmbGrupo.Text = dtgAlumnos.CurrentRow.Cells["grupo"].Value.ToString();
        }
        ...
        private void btncargar_Click(object sender, EventArgs e)
        {
           ...
           // dtgEstudios.DataSource = _estudioManejador.GetEstudios(txtNombre.Text);
            ...
            _profesorManejador.GetMaterias(cmbMaterias);
            gpbMaterias.Visible = true;
            dtgMaterias.DataSource = _alumnoManejador.GetMateria(txtnocontrol.Text);
