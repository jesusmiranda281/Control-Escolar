...
namespace LogicaNegocio.ControlEscolar
{
    public class Alumnomanejador
    {
        ...
        {
            _alumnoAccesoDatos.Guardarmaterias(materias);
        }
        ...
        public List<Grupos> GetGrupos(ComboBox cmb)
        {
            var listgrupos = _alumnoAccesoDatos.GetGrupos(cmb);
            //lenar lista
            return listgrupos;
        }
        public List<v_materias> GetMateria(string filtro)
        {
            var listestudio = _alumnoAccesoDatos.GetMateria(filtro);
            //lenar lista
            return listestudio;
        }
    }
